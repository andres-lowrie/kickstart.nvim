>[!WARNING]
> I'm not really using this anymore, it's here for lookup purposes really
...
* run: `git clone git@github.com:andres-lowrie/kickstart.nvim.git ~/.config/nvim` OR: `gh repo clone nvim-lua/kickstart.nvim`
